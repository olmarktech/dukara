...
class KeyFeatureStyleOne extends PageBuilderBase
{

    public function preview_image()
    {
        return 'Tenant/home/key-feature-01.png';
    }
    ...
    public function frontend_render()
    {
        ...
        if ($is_lexend_v4) {
            ...
            $theme_widget_path = 'themes.lexend-v4.widgets.key-feature-one';
        ...
        return self::renderView('tenant.home-one.home-one-key-feature-one',$data);
