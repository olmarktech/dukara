...
<!-- Section start -->
<div id="<?php echo e($section_id ?: 'themes_showcase'); ?>" class="hero-header section panel overflow-hidden">
        ...
        <div class="container max-w-lg">
            <div class="section-inner panel mt-2 sm:mt-4 lg:mt-0">
                ...
                <div class="panel vstack items-center gap-3 lg:gap-4 mb-6 sm:mb-8 lg:mb-9 max-w-650px mx-auto text-center" data-anime="targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: spring(1, 80, 10, 0); duration: 450; delay: anime.stagger(100, {start: 200});">
                    <?php if($title): ?>
                        <h1 class="h2 sm:h1 lg:display-6 xl:display-5 m-0"><?php echo e($title); ?></h1>
                    <?php endif; ?>
                    <?php if($subtitle): ?>
                        <p class="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70"><?php echo e($subtitle); ?></p>
                    <?php endif; ?>
                </div>
                    ...
                    <?php $__currentLoopData = $all_themes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $theme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="feature-item panel px-3 lg:px-4 py-4 rounded-2 bg-secondary dark:bg-gray-800" data-anime="onview: -200; translateY: [48, 0]; opacity: [0, 1]; easing: spring(1, 80, 10, 0); duration: 450; delay: 100;">
                            <div class="row child-cols col-match justify-between g-4 lg:g-8 xl:g-10">
                                ...
                                <div class="order-0 lg:order-<?php echo e($loop->index % 2 == 0 ? '1' : '0'); ?>">
                                    <div class="panel w-100 rounded lg:rounded-2 overflow-hidden">
                                        <a href="<?php echo e($final_url); ?>" target="_blank">
                                            <img src="<?php echo e($final_image); ?>" alt="<?php echo e($final_name); ?>" class="w-100">
                                        </a>
                                    </div>
                                </div>
                                
                                
                                <div class="order-1 lg:order-<?php echo e($loop->index % 2 == 0 ? '0' : '1'); ?> col-12 sm:col-5">
                                    <div class="panel vstack justify-center gap-4 h-100">
                                        <div>
                                            <div class="panel vstack gap-2">
                                                <span class="fs-6 fw-bold m-0 text-primary"><?php echo e(str_pad($loop->iteration, 2, '0', STR_PAD_LEFT)); ?>.</span>
                                                <h3 class="h4 lg:h2 m-0"><?php echo e($final_name); ?></h3>
                                                <?php if(!empty($theme_data['description'])): ?>
                                                    <p class="fs-6 lg:fs-5 opacity-70 dark:opacity-80"><?php echo e($theme_data['description']); ?></p>
                                                <?php endif; ?>
                                                <a href="<?php echo e($final_url); ?>" target="_blank" class="uc-link fw-bold hstack gap-narrow mt-2">
                                                    <span><?php echo e($view_button_text); ?></span>
...
<!-- Section end -->
<?php /**PATH C:\wamp64\www\jihost_v1\core\resources\views/themes/lexend-v4/widgets/themes-showcase.blade.php ENDPATH**/ ?>