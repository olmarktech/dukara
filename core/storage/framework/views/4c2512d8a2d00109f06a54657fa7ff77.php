            ...
            <div class="section-inner panel">
                <div class="panel vstack gap-4 sm:gap-6 xl:gap-8">
                    <?php if($title): ?>
                        ...
                        ?>
                        <h2 class="title h3 lg:h2 xl:h1 m-0 text-center max-w-550px mx-auto" data-anime="onview: -100; translateY: [48, 0]; opacity: [0, 1]; easing: spring(1, 80, 10, 0); duration: 450; delay: 250;"><?php echo $final_title; ?></h2>
                    <?php endif; ?>
                    <div class="panel">
                        <div class="row child-cols-12 sm:child-cols-6 lg:child-cols-4 col-match g-3" data-anime="onview: -100; targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: spring(1, 80, 10, 0); duration: 450; delay: anime.stagger(100, {start: 200});">
                            <?php if(!empty($data['repeater_data']) && array_key_exists('repeater_title_', $data['repeater_data'])): ?>
                                <?php $__currentLoopData = $data['repeater_data']['repeater_title_']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item_title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div>
                                            ...
                                            <div class="vstack panel min-h-250px">
                                                ...
                                                <div class="vstack justify-between gap-2 h-100">
                                                    <?php if(!empty($data['repeater_data']['repeater_icon_'][$key])): ?>
                                                        ...
                                                        ?>
                                                        <?php if($is_fontawesome): ?>
                                                            <i class="icon icon-4 <?php echo e($icon_class); ?>" style="font-size: 2.5rem;"></i>
                                                        <?php else: ?>
                                                            <i class="icon icon-4 <?php echo e($icon_class); ?>"></i>
                                                        <?php endif; ?>
                                                    <?php else: ?>
                                                    ...
                                                    <div class="panel">
                                                        <div class="vstack gap-1">
                                                            <h3 class="title h5 m-0 text-inherit"><?php echo e($item_title); ?></h3>
                                                            <?php if(!empty($data['repeater_data']['repeater_description_'][$key])): ?>
                                                                <p class="desc fs-6 opacity-70"><?php echo e($data['repeater_data']['repeater_description_'][$key]); ?></p>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php if(!empty($data['repeater_data']['repeater_link_url_'][$key])): ?>
                                                    <a href="<?php echo e($data['repeater_data']['repeater_link_url_'][$key]); ?>" class="position-cover"></a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
...
<?php /**PATH C:\wamp64\www\jihost_v1\core\resources\views/themes/lexend-v4/widgets/key-features-dark.blade.php ENDPATH**/ ?>