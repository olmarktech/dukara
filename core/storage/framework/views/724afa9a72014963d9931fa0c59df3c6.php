...
<div id="cta" class="cta section panel overflow-hidden">
    <div class="section-outer panel overflow-hidden lg:mx-2 my-2 rounded-2 xl:rounded-3 <?php echo e(!empty($cta_image) ? 'max-h-550px sm:max-h-700px xl:max-h-850px pt-6 lg:pt-8 xl:pt-9' : 'py-6 lg:py-8 xl:py-9'); ?>">
            ...
            <div class="section-inner panel vstack gap-4 lg:gap-6 xl:gap-8">
                    ...
                    <div class="row child-cols-12 justify-between items-center g-3 sm:g-4 text-center lg:text-start">
                        <div class="lg:col-7 xl:col-6">
                            <div class="vstack gap-1 sm:gap-2">
                                ...
                                <?php if($subtitle): ?>
                                    <p class="fs-6 xl:fs-5 text-gray-600 dark:text-white text-opacity-70" data-uc-splitext="types: 'words'" data-anime="onview: -100; targets: > *; translateX: [5, 0]; opacity: [0, 1]; easing: easeOutExpo; duration: 450; delay: anime.stagger(50, {start:650});"><?php echo e($subtitle); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="lg:col-auto">
                            <div class="vstack gap-2 items-center" data-anime="onview: -100; translateY: [24, 0]; opacity: [0, 1]; easing: easeOutExpo; duration: 750; delay: 750;">
                                <?php if($button_text): ?>
                                    <a href="<?php echo e($data['button_url'] ?? '#'); ?>" class="btn btn-md xl:btn-lg btn-primary dark:bg-quaternary dark:border-quaternary dark:text-dark fs-6 rounded-pill px-5 xl:px-7 w-auto">
                ...
                <?php if($cta_image): ?>
                    <div class="panel" data-anime="onview: -100; translateY: [80, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 450;">
                        <?php echo render_image_markup_by_attachment_id($cta_image, 'Dashboard', 'full', false); ?>
...
<?php /**PATH C:\wamp64\www\jihost_v1\core\resources\views/themes/lexend-v4/widgets/newsletter.blade.php ENDPATH**/ ?>