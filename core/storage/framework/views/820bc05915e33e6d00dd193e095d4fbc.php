...
<?php $__env->startSection('page-title', __('Register')); ?>
                        ...
                        <div class="panel vstack justify-center h-100 overflow-hidden">
                            ...
                            <div class="panel py-4 px-2">
                                <div class="panel vstack gap-3 w-100 sm:w-350px mx-auto text-center" data-anime="targets: >*; translateY: [24, 0]; opacity: [0, 1]; easing: easeInOutExpo; duration: 750; delay: anime.stagger(100);">
                                    <h1 class="h4 sm:h2"><?php echo e(__('Create an account')); ?></h1>
                                    <div id="msg-wrapper"></div>
                                    
                                    <?php if(url('/') == 'https://nazmart.net' || url('/') == 'https://nazmart.test'): ?>
                                    ...
                                    <form class="vstack gap-3" id="register-form" action="<?php echo e(route('landlord.user.register.store')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        
                                        <input class="form-control h-48px w-full bg-white dark:bg-opacity-0 dark:text-white dark:border-gray-300 dark:border-opacity-30 rounded" type="text" name="name" placeholder="<?php echo e(__('Name')); ?>" value="<?php echo e(old('name')); ?>" required>
                                        
                                        <input class="form-control h-48px w-full bg-white dark:bg-opacity-0 dark:text-white dark:border-gray-300 dark:border-opacity-30 rounded" type="text" name="username" placeholder="<?php echo e(__('Username')); ?>" value="<?php echo e(old('username')); ?>" required>
                                        
                                        <input class="form-control h-48px w-full bg-white dark:bg-opacity-0 dark:text-white dark:border-gray-300 dark:border-opacity-30 rounded" type="email" name="email" placeholder="<?php echo e(__('Email Address')); ?>" value="<?php echo e(old('email')); ?>" required>
                                        
                                        <input class="form-control h-48px w-full bg-white dark:bg-opacity-0 dark:text-white dark:border-gray-300 dark:border-opacity-30 rounded" type="tel" name="phone" id="telephone" placeholder="<?php echo e(__('Phone Number')); ?>" value="<?php echo e(old('phone')); ?>" required>
                                        ...
                                        <div class="position-relative">
                                            <input class="form-control h-48px w-full bg-white dark:bg-opacity-0 dark:text-white dark:border-gray-300 dark:border-opacity-30 rounded pe-48px" type="password" name="password_confirmation" id="password_confirmation" placeholder="<?php echo e(__('Confirm Password')); ?>" required>
                                            <span class="position-absolute top-50 end-0 translate-middle-y pe-3 z-1 cursor-pointer toggle-password" style="cursor: pointer; z-index: 10;">
                                                <i class="unicon-eye-slash show-icon"></i>
                                                <i class="unicon-eye hide-icon d-none"></i>
                                            </span>
                                        ...
                                        <div class="text-start">
                                            <a class="uc-link fs-7" href="javascript:void(0)" id="generate-password">
                                                <i class="unicon-magic-wand"></i> <?php echo e(__('Generate random password')); ?>
                                        ...
                                        <div class="hstack text-start">
                                            <div class="form-check text-start rtl:text-end w-100">
                                                ...
                                                <label for="uc_form_check_terms" class="form-check-label fs-6 lh-normal">
                                                    ...
                                                    <a href="<?php echo e($terms_condition_page); ?>" target="_blank" class="uc-link ltr:ms-narrow rtl:me-narrow"><?php echo e(__('terms and conditions')); ?></a>
                                                    <?php echo e(__('and')); ?>

                                                    <a href="<?php echo e($privacy_policy_page); ?>" target="_blank" class="uc-link ltr:ms-narrow rtl:me-narrow"><?php echo e(__('privacy policy')); ?></a>.
                                                </label>
                                            </div>
                                        </div>
                                        
                                        <button class="btn btn-primary btn-md text-white mt-2 w-full" type="submit" id="register_button"><?php echo e(__('Sign Up Now')); ?></button>
                                    </form>
                                    
                                    <p><?php echo e(__('Already have an account?')); ?> <a class="uc-link" href="<?php echo e(route('landlord.user.login')); ?>"><?php echo e(__('Sign in')); ?></a></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php if (isset($component)) { $__componentOriginal49bb06509989d7c7a37ac27a02d78fa3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal49bb06509989d7c7a37ac27a02d78fa3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.custom-js.generate-password','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal49bb06509989d7c7a37ac27a02d78fa3)): ?>
<?php $attributes = $__attributesOriginal49bb06509989d7c7a37ac27a02d78fa3; ?>
<?php unset($__attributesOriginal49bb06509989d7c7a37ac27a02d78fa3); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal49bb06509989d7c7a37ac27a02d78fa3)): ?>
<?php $component = $__componentOriginal49bb06509989d7c7a37ac27a02d78fa3; ?>
<?php unset($__componentOriginal49bb06509989d7c7a37ac27a02d78fa3); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.custom-js.phone-number-config','data' => ['selector' => '#telephone']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
        ...
        if (registerForm) {
            registerForm.addEventListener('submit', function (event) {
                ...
                axios({
                    ...
                    registerFormButton.innerText = "<?php echo e(__('Sign Up Now')); ?>";
...
<?php echo $__env->make('themes.lexend-v4.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\jihost_v1\core\resources\views/themes/lexend-v4/auth/register.blade.php ENDPATH**/ ?>