...
<div class="general-info-wrapper">
    ...
    <div class="general-info-form mt-0 mt-lg-4">
        <div class="dashboard-input mt-4">
            ...
            <input type="number" class="form--control radius-10" value="{{ $product?->cost }}" name="cost" placeholder="{{ __("Base Cost...") }}">
            <p>{{ __("Purchase price of this product.") }}</p>
        </div>

        <div class="dashboard-input mt-4">
            <label class="dashboard-label color-light mb-2"> {{ __("Regular Price") }}</label>
                <input type="number" class=" form--control radius-10" value="{{ $product?->price }}" name="price" placeholder="{{ __("Enter Regular Price...") }}">
        ...
        <div class="dashboard-input mt-4">
            ...
            <input type="number" class="form--control radius-10" value="{{ $product?->sale_price }}" name="sale_price" placeholder="{{ __("Enter Sale Price...") }}">
