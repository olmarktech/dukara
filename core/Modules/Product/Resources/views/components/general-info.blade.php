...
{{--            </div>--}}
            ...
            <div class="dashboard-input mt-4">
                ...
                <textarea class="form--control summernote radius-10 is-invalid" name="description" required>{!! $product?->description ?? "" !!}</textarea>
            ...
            <div class="dashboard-input mt-4">
                <label class="dashboard-label color-light mb-2"> {{ __("Brand") }}<x-fields.mandatory-indicator/> </label>
