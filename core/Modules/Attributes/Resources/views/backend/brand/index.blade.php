    ...
    @can('brand-manage-create')
        <div class="modal fade" id="brand_manage_create_modal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{__('Create New brand')}}</h5>
                        <button type="button" class="close" data-bs-dismiss="modal"><span>×</span></button>
                    </div>
                    <div class="card-body">
...
{{--                            <x-fields.media-upload :title="'Banner'" :name="'banner_id'" :dimentions="'200x200'"/>--}}
                            ...
                            @if(!empty(get_static_option('tenant_admin_dashboard_theme') ) && get_static_option('tenant_admin_dashboard_theme') == 'metronic')
                                <x-fields.media-upload-for-metronic :title="__('Logo')" :name="'image_id'" :dimentions="'200x200'"/>
                            @else
                                <x-fields.media-upload :title="'Logo'" :name="'image_id'" :dimentions="'200x200'"/>
                            @endif

                            @if(!empty(get_static_option('tenant_admin_dashboard_theme') ) && get_static_option('tenant_admin_dashboard_theme') == 'metronic')
                                <x-fields.media-upload-for-metronic :title="__('Banner')" :name="'banner_id'" :dimentions="'120x120'"/>
                            @else
                                <x-fields.media-upload :title="'Banner'" :name="'banner_id'" :dimentions="'200x200'"/>
                            @endif
