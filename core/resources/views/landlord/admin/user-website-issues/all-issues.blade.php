                ...
                <form action="{{route('landlord.admin.failed.database.generate')}}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <input class="form-control database-name mt-2" type="text" name="database_name"
                                   id="database-name" autocomplete="off" placeholder="Database name">

                            <!-- Switch -->
{{--                            <div class="form-check form-switch mt-3">--}}
{{--                                <label class="form-check-label" for="dbUserSwitch">{{__('Use Database Username & Password')}}</label>--}}
{{--                                <input class="form-check-input" type="checkbox" id="dbUserSwitch">--}}
{{--                            </div>--}}
                            <!-- Switch -->
                            <div class="form-check form-switch mt-3">
                                <input class="" type="checkbox" id="dbUserSwitch">
                                <label class="" for="dbUserSwitch">
                                    {{__('Use Database Username & Password')}}
                                </label>
                            </div>

                            <!-- Hidden by default -->
                            <div id="dbUserFields" class="mt-3" style="display:none;">
                                <input class="form-control mt-2" type="text" name="database_user_name"
                                       id="database_user_name" autocomplete="off" placeholder="Database User name">
                                <input class="form-control mt-2" type="password" name="database_user_password"
                                       id="database_user_password" autocomplete="off" placeholder="Database User password">
                            </div>
...
@section('scripts')
    ...
    <script>
        ...
        document.getElementById('dbUserSwitch').addEventListener('change', function () {
            let fields = document.getElementById('dbUserFields');
