            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="my-order">
                        ...
                        <li><strong>{{__('Expire Date')}}:</strong> {{ tenant() && tenant()->expire_date ? $current_package->expire_date?->format('d M Y') : '' }} -
                            {{tenant() && tenant()->expire_date ? $current_package->expire_date->diffForHumans(parts: 4) : '' }}</li>
                    </ul>
