...
@section('scripts')
    ...
    <script>
        $(function (){
                ...
                $.ajax({
                    ...
                    success: (data) => {
                        ...
                        if (data.type === 'success')
                        {
                            ...
                            $('.price-total span').text(currency_symbol+data.total);
                            $('.price-total').attr('data-total', data.total);
            ...
            //========== new code for both gateway option show
            ...
            // =======end new code for both gateway option show
