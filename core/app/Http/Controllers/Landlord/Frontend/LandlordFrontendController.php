...
class LandlordFrontendController extends Controller
{
    ...
    public function homepage()
    {
        ...
        $active_theme = get_static_option('active_frontend_theme') ?? 'default';
        if ($active_theme === 'lexend-v4' && view()->exists('themes.lexend-v4.pages.home')) {
            return view('themes.lexend-v4.pages.home', compact('page_post'));
        }
...
// ========================================== LANDLORD HOME PAGE TENANT ROUTES ====================================
    ...
    public function showTenantLoginForm()
    {
        ...
        // Check for active theme-specific view
        $active_theme = get_static_option('active_frontend_theme') ?? 'default';
        if ($active_theme === 'lexend-v4' && view()->exists('themes.lexend-v4.auth.login')) {
            return view('themes.lexend-v4.auth.login');
        }
...
//        dd($plan_id);
        ...
        // Check for active theme-specific view
        $active_theme = get_static_option('active_frontend_theme') ?? 'default';
        if ($active_theme === 'lexend-v4' && view()->exists('themes.lexend-v4.auth.register')) {
            return view('themes.lexend-v4.auth.register', compact('plan_id'));
        }
