...
class TenantDashboardController extends Controller
{
    ...
    public function dashboard(){
        ...
        $theme_name = get_static_option('tenant_admin_dashboard_theme') ?? 'default';
...
//        return view(self::BASE_PATH.'profile.edit-profile');
        ...
        $render_view_file = $theme_meta_instance->getThemeOverrideViews($theme_name,'edit_profile',self::BASE_PATH.'profile.edit-profile');
