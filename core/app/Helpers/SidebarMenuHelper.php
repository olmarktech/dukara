...
//        $this->testimonial_settings_menus($menu_instance);
        ...
        foreach (getAllExternalMenu() as $externalMenu) {
            foreach ($externalMenu as $individual_menu_item) {
                ...
                if (isPluginActive('Integrations')
                    && str_contains($convert_to_array['id'], 'integration')) {
                ...
                if (isPluginActive('SmsGateway') && str_contains($convert_to_array['id'], 'sms-manage-index')) {
                    $convert_to_array['parent'] = 'general-settings-menu-items';
                }
...
// testimonial
    ...
    private function price_plan_settings_menus(MenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('price-plan-settings-menu-items', [
            ...
            'label' => __('Price Plan'),
            'parent' => null,
            'permissions' => ['price-plan-list', 'price-plan-create', 'price-plan-edit', 'price-plan-delete','coupon-list'],
    ...
    private function blog_settings_menus(MenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('blog-settings-menu-items', [
            ...
            'label' => __('Blogs'),
            'parent' => null,
            'permissions' => ['blog-list', 'blog-create', 'blog-edit', 'blog-delete', 'blog-settings','newsletter', 'newsletter-list', 'newsletter-create', 'newsletter-edit', 'newsletter-delete'], //
    ...
    private function general_settings_menus(MenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('general-settings-menu-items', [
            ...
            'permissions' => ['general-settings-page-settings', 'general-settings-site-identity', 'general-settings-basic-settings', 'general-settings-color-settings',
                ...
                'general-settings-database-upgrade-settings', 'general-settings-cache-clear-settings', 'general-settings-license-settings','language-list',
                'language-create', 'language-edit', 'language-delete'],
    ...
    private function users_manage_menus(MenuWithPermission $menu_instance): void
    {
        ...
        $menu_instance->add_menu_item('admins-forbidden-subdomain-menu-items', [
            'route' => 'landlord.admin.forbidden.subdomain',
            'label' => __('Forbidden Subdomains'),
            'parent' => 'users-manage-settings-menu-items',
            'permissions' => [],
        ]);
    }
        ...
        foreach (getAllExternalMenu() as $externalMenu) {
            foreach ($externalMenu as $individual_menu_item) {
                ...
                $routeName = $convert_to_array['tenantRoute']
                    ?? $convert_to_array['routeName']
                    ?? '';

//                 Check if shipping plugin is active and adjust parent
//                if (isPluginActive('Integrations')
//                    && str_contains($convert_to_array['id'], 'integration')) {
//                    $convert_to_array['parent'] = 'general-settings-menu-items';
//                }
...
//                    $convert_to_array['parent'] = 'all-plugins-menu';
//                }
...
//                }
            ...
            // collect all external menus from multiple plugins/modules
    ...
    private function tenant_order_manage_settings_menus(MenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('product-order-manage-settings', [
            ...
            'permissions' => ['product-order-all-order', 'product-order-pending-order',
                ...
                'product-order-manage-settings', 'product-order-invoice-settings','inventory-list', 'inventory-create',
                'inventory-edit', 'inventory-delete', 'inventory-settings','refund-chat-list', 'refund-chat-create', 'refund-chat-edit', 'refund-chat-delete'
            ],
            'icon' => 'mdi mdi-cart',
        ]);
...
//    private function tenant_all_plugin_menus(MenuWithPermission $menu_instance): void
//    {
//        $menu_instance->add_menu_item('all-plugins-menu', [
//            'route' => '#',
...
//
//    }
    private function tenant_product_manage_menus(MenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('product_manage-menu-items', [
            'route' => '#',
            'label' => __('Offers & Campaigns'),
            'parent' => null,
            'permissions' => [
        ...
        if (tenant_plan_sidebar_permission('coupon')) {
            $menu_instance->add_menu_item('product-coupon-settings-menu-items', [
                ...
                'label' => __('All Coupon'),
                'parent' => 'product_manage-menu-items',
    ...
    private function tenant_general_settings_menus(MenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('general-settings-menu-items', [
            ...
            'permissions' => ['general-settings-page-settings', 'general-settings-site-identity', 'general-settings-basic-settings', 'general-settings-color-settings',
                ...
                'general-settings-cache-clear-settings', 'general-settings-license-settings','language-list', 'language-create', 'language-edit', 'language-delete'],
            'icon' => 'mdi mdi-settings',
        ]);
