...
class ThemeMetaData
{
    ...
    public function getAllThemeDataForAdmin()
    {
        ...
        foreach ($allDirectories as $dire) {
            ...
            if ($themeInformation !== null && property_exists($themeInformation, 'slug')) {
    ...
    public function getAllThemeData()
    {
        ...
        foreach ($allDirectories as $dire) {
            ...
            if ($themeInformation !== null && property_exists($themeInformation, 'status') && $themeInformation->status) {
    ...
    public function getAllThemeSlug()
    {
        ...
        foreach ($allThemeData as $data) {
            if ($data !== null && property_exists($data, 'status') && $data->status) {
